...
//
//
//    printf("Arrival Station To Search > ");
//    rewind(stdin);
//    gets(searchName);
//
//
...
//    printf("-----------------------------------------------------------------------------------------------------------------------------\n");
//    for (int i = 0; i < 10; i++) {
//        if (strcmp(searchName, scheduleList[i].arrivalStation) == 0) {
//            printf(" %s\t  %s\t %-30s\t %s\t\t %s\t \t%d\t\n", scheduleList[i].trainNum, scheduleList[i].departureStation, scheduleList[i].arrivalStation, scheduleList[i].departureTime, scheduleList[i].arrivalTime, scheduleList[i].availableSeat);
//            count++;
//        }
//    }
//    printf("===============================================================================================================================\n\n");
//    printf("%d records found for Arrival Station = %s\n", count, searchName);
//    printf("Press 1 to continue Ticket Booking or Press 2 back to search Train Schedule\n");
//    scanf("%d", c);
//    switch (c) {
//    case 1:
//        break;
